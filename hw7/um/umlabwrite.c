...
extern void build_print_a_digit(Seq_T instructions);
extern void build_input_test(Seq_T stream);
extern void build_load_val_test(Seq_T stream);
extern void build_mult_test(Seq_T stream);
extern void build_segment_test(Seq_T stream);
extern void build_mapping_test(Seq_T stream);
extern void build_memory_test(Seq_T stream);
...
extern void build_map_seg_test(Seq_T stream);
...
static struct test_info {
        ...
        { "print-six", NULL, "6", build_print_a_digit},
        { "input", NULL, "", build_input_test},
        { "loadval", NULL, "", build_load_val_test},
        { "multiply", NULL, "", build_mult_test},
        { "segment", NULL, "", build_segment_test},
        { "mapping", NULL, "", build_mapping_test},
        { "memory", NULL, "Hi", build_memory_test},
        ...
        {"map-seg", NULL, "", build_map_seg_test},
        {"unmap-seg", NULL, "", build_unmap_seg_test}
};
